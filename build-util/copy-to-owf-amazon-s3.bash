...
# Get the InfoMapper version and Clear Creek Basin Information Portal version.
...
printUsage() {
  ...
  echoStderr ""
  echoStderr "Copy the Clear Creek Basin Information Portal application files to the Amazon S3 static website folder(s),"
...
printVersion() {
  ...
  echoStderr ""
  echoStderr "Clear Creek Basin Information"
...
s3FolderVersionUrl="s3://rivers.openwaterfoundation.org/state/co/clear/${appVersion}"
s3FolderLatestUrl="s3://rivers.openwaterfoundation.org/state/co/clear/latest"
