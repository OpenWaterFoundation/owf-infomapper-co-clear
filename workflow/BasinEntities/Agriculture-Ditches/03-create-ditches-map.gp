# Create a GeoMapProject file for Ditches:
...
CreateGeoMap(NewGeoMapID="DitchesMap",Name="Ditches",Description="Ditch service areas and canals from CDSS.",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.55,39.77,10',docPath:'ditches-map.md'")
...
#
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dola/district-boundaries/latest/co-soil-conservation-districts-waterdistrict7.geojson",GeoLayerID="SoilConservationDistrictsLayer",Name="Soil Conservation Districts",Description="Soil conservation districts from DOLA.")
...
#
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-ditch-service-area-district7-1956.geojson",GeoLayerID="DitchServiceAreas1956Layer",Name="Ditch Service Areas",Description="Ditch service areas (1956) for District 7 from Colorado's Decision Support Systems.")
# The following layer view group is used for all years
AddGeoLayerViewToGeoMap(GeoLayerID="DitchServiceAreas1956Layer",GeoLayerViewID="DitchServiceAreas1956LayerView",Name="District 7 Ditch Service Areas (1956)",Description="Ditch service areas (1956) from CDSS",InsertPosition="Top",Properties="docPath:layers/ditch-service-areas.md,selectedInitial:false,highlightEnabled:true")
...
# - color is orange
# GeoLayerViewGroupID: DitchServiceAreasGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-ditch-service-area-district7-1976.geojson",GeoLayerID="DitchServiceAreas1976Layer",Name="Saint Vrain Ditch Service Areas (1976)",Description="Ditch service areas (1976) for District 7 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="DitchServiceAreas1976Layer",GeoLayerViewID="DitchServiceAreas1976LayerView",Name="District 7 Ditch Service Areas (1976)",Description="Ditch service areas (1976) from CDSS",InsertPosition="Top",Properties="docPath:layers/ditch-service-areas.md,selectedInitial:false,highlightEnabled:true")
...
# - color is cyan
# GeoLayerViewGroupID: DitchServiceAreasGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-ditch-service-area-district7-1987.geojson",GeoLayerID="DitchServiceAreas1987Layer",Name="Saint Vrain Ditch Service Areas (1987)",Description="Ditch service areas (1987) for District 7 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="DitchServiceAreas1987Layer",GeoLayerViewID="DitchServiceAreas1987LayerView",Name="District 7 Ditch Service Areas (1987)",Description="Ditch service areas (1987) from CDSS",InsertPosition="Top",Properties="docPath:layers/ditch-service-areas.md,selectedInitial:false,highlightEnabled:true")
...
# GeoLayerViewGroupID: DitchServiceAreasGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-ditch-service-area-district7-2001.geojson",GeoLayerID="DitchServiceAreas2001Layer",Name="Saint Vrain Ditch Service Areas (2001)",Description="Ditch service areas (2001) for District 7 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="DitchServiceAreas2001Layer",GeoLayerViewID="DitchServiceAreas2001LayerView",Name="District 7 Ditch Service Areas (2001)",Description="Ditch service areas (2001) from CDSS",InsertPosition="Top",Properties="docPath:layers/ditch-service-areas.md,selectedInitial:false,highlightEnabled:true")
...
# - color is green
# GeoLayerViewGroupID: DitchServiceAreasGroup
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-ditch-service-area-district7-2005.geojson",GeoLayerID="DitchServiceAreas2005Layer",Name="Saint Vrain Ditch Service Areas (2005)",Description="Ditch service areas (2005) for District 7 from Colorado's Decision Support Systems.")
AddGeoLayerViewToGeoMap(GeoLayerID="DitchServiceAreas2005Layer",GeoLayerViewID="DitchServiceAreas2005LayerView",Name="District 7 Ditch Service Areas (2005)",Description="Ditch service areas (2005) from CDSS",InsertPosition="Top",Properties="docPath:layers/ditch-service-areas.md,selectedInitial:true,highlightEnabled:true")
...
#
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/irrigated-lands/co-dwr-canals-district7.geojson",GeoLayerID="CanalsLayer",Name="Canals (ditches)",Description="Canals (ditches)")
...
#CopyFile(SourceFile="../Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-7.md",DestinationFile="${MapFolder}/layers/co-dwr-water-district-7.md")
#
