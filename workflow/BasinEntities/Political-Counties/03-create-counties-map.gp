...
# - filter out counties that intersect the Clear Creek Basin
...
#CopyFile(SourceFile="../Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-7.md",DestinationFile="layers/co-dwr-water-district-7.md.json")
