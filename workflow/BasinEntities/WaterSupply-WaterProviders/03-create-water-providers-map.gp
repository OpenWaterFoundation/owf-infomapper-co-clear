...
CreateGeoMap(NewGeoMapID="WaterProvidersMap",Name="Water Providers",Description="Water Providers",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.55,39.77,10',docPath:'water-providers-map.md'")
...
SetGeoLayerViewEventHandler(GeoLayerViewID="WaterDistrictLayerView",EventType="click",Name="Click event",Description="Click event configuration",Properties="eventConfigPath:../Administration-CoDwrWaterDistricts/layers/co-dwr-water-district--7event-config.json")
# = = = = = = = = = =
...
#
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dola/district-boundaries/latest/co-fire-protection-districts-waterdistrict7.geojson",GeoLayerID="FireProtectionDistrictsLayer",Name="Fire Protection Districts",Description="Fire protection districts from DOLA.")
