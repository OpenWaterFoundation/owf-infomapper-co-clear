...
CreateGeoMap(NewGeoMapID="EnvironmentOrgMap",Name="Environmental Organizations",Description="Environmental Organizations",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.55,39.77,10',docPath:'environment-orgs-map.md'")
