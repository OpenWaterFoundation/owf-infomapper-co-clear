...
CreateGeoMap(NewGeoMapID="MunicipalitiesMap",Name="Municipalities",Description="Municipalities",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.55,39.77,10',docPath:'municipalities-map.md'")
...
#CopyFile(SourceFile="../Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-7-event-config.json",DestinationFile="layers/co-dwr-water-district-7-event-config.json")
