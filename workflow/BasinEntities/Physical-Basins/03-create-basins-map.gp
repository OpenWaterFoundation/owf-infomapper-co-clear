...
# - GeoMapID:  BasinsMap
CreateGeoMapProject(NewGeoMapProjectID="BasinsProject",ProjectType="SingleMap",Name="Clear Creek Basins",Description="Clear Creek Basins",Properties="author:'Open Water Foundation',specificationFlavor:'',specificationVersion:'1.0.0'")
CreateGeoMap(NewGeoMapID="BasinsMap",Name="Clear Creek Basins",Description="Clear Creek Basins",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.55,39.77,10',docPath:basins-map.md")
...
# HUC 8 next on top
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/country/us/usgs/huc-basins/huc8-basin-10190004-clear.geojson",GeoLayerID="HUC8BasinLayer",Name="HUC8 Basin: 10190004, Clear Creek",Description="HUC8 Basin boundaries from the USGS")
AddGeoLayerViewToGeoMap(GeoLayerID="HUC8BasinLayer",GeoLayerViewID="HUC8BasinsLayerView",Name="HUC8 Basin: 10100004, Clear Creek",Description="HUC8 Basin boundaries from the USGS",InsertPosition="Top",Properties="docPath:layers/huc8.md")
...
# HUC 10 next on top
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/country/us/usgs/huc-basins/huc10-basins-10190004-clear.geojson",GeoLayerID="HUC10BasinLayer",Name="Clear Creek HUC10 Basins",Description="HUC10 Basin boundaries from the USGS")
AddGeoLayerViewToGeoMap(GeoLayerID="HUC10BasinLayer",GeoLayerViewID="HUC10BasinsLayerView",Name="Clear Creek HUC10 Basins",Description="HUC10 Basin boundaries from the USGS",InsertPosition="Top",Properties="docPath:layers/huc10.md,highlightEnabled:true")
...
AddGeoLayerViewToGeoMap(GeoLayerID="HUC12BasinLayer",GeoLayerViewID="HUC12BasinsLayerView",Name="Clear Creek HUC 12 Basins",Description="HUC12 Basin boundaries from the USGS",InsertPosition="Top",Properties="docPath:layers/huc12.md,highlightEnabled:true")
