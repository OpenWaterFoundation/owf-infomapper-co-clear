...
CreateGeoMap(NewGeoMapID="CurrentSnowpackMap",Name="Current Snowpack",Description="Current snowpack",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.55,39.77,10',docPath:snowpack-map.md")
...
#CopyFile(SourceFile="layers/co-dwr-water-district-7-event-config.json",DestinationFile="${MapFolder}/layers/co-dwr-water-district-7-event-config.json")
